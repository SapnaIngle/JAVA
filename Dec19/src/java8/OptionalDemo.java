...
//        System.out.println(optional.get());
        ...
        System.out.println(optional2.orElse("Radha"));

        Optional <String> optional3 = Optional.ofNullable(obj.getName());
        System.out.println(optional3.orElseGet(()->"Ram"));
        ...
        try {
            ...
            System.out.println(optional5.orElseThrow(()->new Exception("Throwing Exception")));
        } catch (Exception e) {
